...
export default function StarRating({starCount=5}){
    ...
    function handleMouseLeave(){
        ...
        // 별에서 마우스가 나갔는지? : 점수랑 동일하게 맞춰준다(색깔 맞추기 위해)
        setHover(score);
            ...
            <div>
                {
                    ...
                    stars.map((e, idx)=>{
                        ...
                        // 반복적으로 생성할 HTML(JSX)은 return 에 작성
                        return(
                            <FaStar size={40} key={e}
                            // 마우스가 올라가있거나, 선택된 상태면 클래스명을 변경(클릭, 마우스무브, 마우스리브)
